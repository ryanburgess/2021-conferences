...
_**The \`.ics\` file can be downloaded [here](https://rawgit.com/ryanburgess/${year - 1}-conferences/master/${year - 1}-conferences.ics), but it's recommended to add it via URL (if your client supports that). Thus, you will dynamically get all updates.**_
`;
